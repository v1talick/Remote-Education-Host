...
public class TeacherRepositoryTest {
    ...
    public void getTeacherByIdTest() {
        Teacher teacher = teacherRepository.getTeacherById(3).get();
    ...
    public void updateTeacherTest() {
        Teacher teacher = teacherRepository.getTeacherById(4).get();
        teacher.setScienceDegree(ScienceDegree.ASSOCIATE_OF_SCIENCE);
        teacherRepository.updateTeacher(teacher);
        assertEquals(ScienceDegree.ASSOCIATE_OF_SCIENCE, teacherRepository.getTeacherById(4).get().getScienceDegree());
    }
    @Test
